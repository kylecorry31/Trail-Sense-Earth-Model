...
output_directory = 'images/got5.5'
x_scale = 0.125
y_scale = 0.125
width = 2880
height = 1441
    ...
    with progress.progress(f'Processing ocean tides', len(constituents) * 2) as pbar:
        ...
        for constituent in constituents:
            ...
            with netCDF4.Dataset(file_path, 'r') as file:
                ...
                updated = to_tif(phase, f'{output_directory}/{constituent}-phase.tif', True, x_shift, 100000, (width, height))
                # Mask the image
                ...
                pbar.update(1)
                updated = to_tif(amplitude, f'{output_directory}/{constituent}-amplitude.tif', True, x_shift, 100000, (width, height))
                # Mask the image
                updated = updated * mask
                updated[updated == 0] = 100000
                min_amplitude = 0.0
                ...
                updated[updated != 100000] = normalized#curve
