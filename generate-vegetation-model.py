...
files = [f'images/{end_year}-{end_year}-7-vegetation.tif']
compression.minify_multiple(files, lambda x: x, -999, 'vegetation', True, 100, True, (576, 361), a_override=1, b_override=0)
